...
-- que incia en 112.XXX.XXX.XXX
	...
	SELECT
		COUNT(*),
		country, last_connection
	FROM 
		"users"
	WHERE country = 'Iceland'
	GROUP BY country, last_connection
...
-- Tip: Agrupar condiciones entre paréntesis 
	...
	SELECT 
	 ...
	 WHERE
	 	...
	 	OR (country = 'Iceland' AND last_connection LIKE '28.%') 
	 	OR (country = 'Iceland' AND last_connection LIKE '188.%');
